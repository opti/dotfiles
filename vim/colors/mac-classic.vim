...
hi Visual  guifg=NONE guibg=#98b0d2 gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#98b0d2 gui=NONE
...
hi Todo  guifg=#80b5ff guibg=NONE gui=inverse,bold,italic
...
hi erubyComment  guifg=#80b5ff guibg=NONE gui=italic
